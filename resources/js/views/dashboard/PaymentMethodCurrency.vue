      ...
      <v-col cols="12" sm="12" order-sm="2">
          ...
          <v-row class="px-4">
            <v-col class="col-md-10 pr-md-1">
              <h2 class="col-md-10 pr-md-1">
                {{ getPaymentMethodCurencyDetails.code }}
              </h2>
            </v-col>
                  ...
                  <v-row>
                    ...
                    <v-col cols="12" class="py-2">
                      <p class="font-weight-bold">
                        ...
                        >Exchange Rate:
                        {{ getPaymentMethodCurencyDetails.exchangeRate }}
                        <a
                          @click="
                            OpenEditModule(
                              'exchangeRate',
                              'Exchange Rate',
                              getPaymentMethodCurencyDetails.exchangeRate || 0.0
                            )
                          "
                      ...
                      <p class="font-weight-bold">
                        <v-icon color="primary">mdi-currency-eur</v-icon>
                        Buy:
                        {{ getPaymentMethodCurencyDetails.buy }}
                        <a
                          @click="
                            OpenEditModule(
                              'buy',
                              'Buy Price',
                              getPaymentMethodCurencyDetails.buy || 0.0
                            )
                          "
                          ><v-icon color="primary">mdi-pencil</v-icon></a
                        >
                      ...
                      <p class="font-weight-bold">
                        <v-icon color="primary">mdi-currency-eur</v-icon>
                        Sell:
                        {{ getPaymentMethodCurencyDetails.sell }}
                        <a
                          @click="
                            OpenEditModule(
                              'sell',
                              'Sell Price',
                              getPaymentMethodCurencyDetails.sell || 0.0
                            )
                          "
                          ><v-icon color="primary">mdi-pencil</v-icon></a
                        >
                      ...
                      <p class="font-weight-bold">
                        <v-icon color="primary">mdi-currency-eur</v-icon>
                        Charge Percentage:
                        {{ getPaymentMethodCurencyDetails.chargePercentage }}
                        <a
                          @click="
                            OpenEditModule(
                              'chargePercentage',
                      ...
                      <p class="font-weight-bold">
                        <v-icon color="primary">mdi-currency-eur</v-icon>
                        Txn Fee:
                        {{ getPaymentMethodCurencyDetails.transactionFee }}
                        <a
                          @click="
                            OpenEditModule(
                              'transactionFee',
                  ...
                  <v-row>
                    ...
                    <v-col cols="12" class="py-2">
                      <p class="font-weight-bold">
                        <v-icon color="primary">mdi-currency-eur</v-icon>
                        Currency:
                        {{ getPaymentMethodCurencyDetails.currency }}
                      </p>
                      <p class="font-weight-bold">
                        <v-icon color="primary">mdi-currency-eur</v-icon>
                        Max Withdrow Limite:
                        {{ getPaymentMethodCurencyDetails.maxWithdrowLimit }}
                        <a
                          @click="
                            OpenEditModule(
                              'maxWithdrowLimit',
                      ...
                      <p class="font-weight-bold">
                        <v-icon color="primary">mdi-currency-eur</v-icon>
                        Min Withdrow Limite:
                        {{ getPaymentMethodCurencyDetails.minWithdrowLimit }}
                        <a
                          @click="
                            OpenEditModule(
                              'minWithdrowLimit',
                      ...
                      <p class="font-weight-bold">
                        <v-icon color="primary">mdi-currency-eur</v-icon>
                        Max Deposit Limite:
                        {{ getPaymentMethodCurencyDetails.maxDepositLimit }}
                        <a
                          @click="
                            OpenEditModule(
                              'maxDepositLimit',
                      ...
                      <p class="font-weight-bold">
                        <v-icon color="primary">mdi-currency-eur</v-icon>
                        Min Deposit Limite:
                        {{ getPaymentMethodCurencyDetails.minDepositLimit }}
                        <a
                          @click="
                            OpenEditModule(
                              'minDepositLimit',
        ...
        <v-dialog v-model="viewCurrencyTariff" width="400">
          <v-card>
            <v-card-title class="headline" primary-title>
              {{
                `${activeCurrencyTariff.minAmmount} - ${activeCurrencyTariff.maxAmmount} (${getPaymentMethodCurencyDetails.currency})`
              }}
            </v-card-title>
        ...
        <v-card class="py-2 pa-2">
          <v-data-table
            :headers="headers"
            :items="getPaymentMethodCurrencyTariffs"
            item-key="id"
          >
...
export default {
  ...
  computed: {
    ...
    ...mapGetters([
      "getPaymentMethodCurrencyTariffs",
      "messageAlert",
      "getPaymentMethodCurencyDetails",
  ...
  watch: {
    ...
    getPaymentMethodCurencyDetails(val) {
      if (val != null) {
