    ...
    <v-col cols="12" lg="12">
      <v-card>
        <v-container class="pa-5">
          <v-row>
            <v-col cols="12" lg="12">
              <h2 class="font-weight-bold mb-0">Request Status</h2>
              <span class="font-weight-bold mb-0 py-2">
                ...
                <a class="text-primary"
                  >https://pay.nsiimbi.com/api/requestToPay/{request_token}</a
                >. <br /><br />Note: Only GET requests are accepted by this API
              </span>
