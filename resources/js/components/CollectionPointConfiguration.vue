        ...
        <v-row class="px-1">
          ...
          <v-col cols="12" sm="12" order="-1" order-sm="2">
            ...
            <p class="font-weight-bold">
              ...
              Handling Fee: {{ data.handlingFee || 0.0 }}
              <a
                @click="
                  OpenEditModule(
                    'handlingFee',
                    'Handling Fee',
                    data.handlingFee || 0.0
                  )
                "
            ...
            <p class="font-weight-bold">
              <v-icon color="primary">mdi-currency-usd-circle-outline</v-icon>
              Delivery Fee/KM: {{ data.deliveryFeePerKM || 0.0 }}
              <a
                @click="
                  OpenEditModule(
                    'deliveryFeePerKM',
                    'Delivery Fee/KM',
                    data.deliveryFeePerKM || 0.0
                  )
                "
                ><v-icon color="primary">mdi-pencil</v-icon></a
              >
            ...
            <p class="font-weight-bold">
              <v-icon color="primary">mdi-currency-usd-circle-outline</v-icon>
              Min Delivery Fee: {{ data.minDeliveryFee || 0.0 }}
              <a
                @click="
                  OpenEditModule(
                    'minDeliveryFee',
                    'Min Delivery Fee',
                    data.minDeliveryFee || 0.0
                  )
                "
                ><v-icon color="primary">mdi-pencil</v-icon></a
              >
            ...
            <p class="font-weight-bold">
              <v-icon color="primary">mdi-currency-usd-circle-outline</v-icon>
              Max Delivery Fee: {{ data.maxDeliveryFee || 0.0 }}
              <a
                @click="
                  OpenEditModule(
                    'maxDeliveryFee',
                    'Max Delivery Fee',
                    data.maxDeliveryFee || 0.0
                  )
                "
                ><v-icon color="primary">mdi-pencil</v-icon></a
              >
        ...
        <v-row class="px-1">
          ...
          <v-col cols="12" sm="12" order="-1" order-sm="2">
            ...
            <p class="font-weight-bold">
              ...
              {{ data.email }}
              <a @click="OpenEditModule('email', 'Email', data.email)"
                ><v-icon color="primary">mdi-pencil</v-icon></a
              >
            </p>
            <p class="font-weight-bold">
              ...
              {{ data.website }}
              <a @click="OpenEditModule('website', 'Website', data.website)"
                ><v-icon color="primary">mdi-pencil</v-icon></a
              >
            </p>
            <p class="font-weight-bold">
              ...
              {{ data.phone }}
              <a @click="OpenEditModule('phone', 'Phone', data.phone)"
                ><v-icon color="primary">mdi-pencil</v-icon></a
              >
            </p>
            <p>
...
export default {
  template: "#CollectionPointConfiguration",
  props: {
    data: {
      type: Object,
      required: true,
