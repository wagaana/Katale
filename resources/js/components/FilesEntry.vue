<template>
  <v-container grid-list-xl class="">
    <v-card @click="dialogOpenFiles = true" class="pa-2">
      <v-row>
        <v-col cols="12" offset-sm="0" sm="4" class="py-4 center">
          <v-img
            :src="
              activeFile.path != null
                ? `${uploads}${activeFile.path}`
        ...
        <v-col cols="12" class="py-5 center" sm="8"> {{ label }} </v-col>
      </v-row>
    </v-card>
