"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_dashboard_BankCurrency_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/dashboard/BankCurrency.vue?vue&type=script&lang=js&":
/*!************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/dashboard/BankCurrency.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeCreate: function beforeCreate() {
    this.$store.dispatch("loadBankCurencyDetails", this.$route.params.currencyCode);
    this.$store.dispatch("fetchPaymentMethodStatistics", this.$route.params.code);
    this.$store.dispatch("fetchBankCurrencyTariffs", this.$route.params.currencyCode);
  },
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapState)(["bankCurrencyTariffs", "bankCurencyDetails", "paymentMethodStatistics"])), (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapGetters)(["getBankCurrencyTariffs", "messageAlert", "getBankCurencyDetails", "getPaymentMethodStatistics"])),
  ...
  watch: {
    ...
    getBankCurencyDetails: function getBankCurencyDetails(val) {
      if (val != null) {
  ...
  methods: {
    ...
    UpdateActiveCurrencyTariff: function UpdateActiveCurrencyTariff() {
      this.$store.dispatch("updateBankCurrencyTariff", this.activeCurrencyTariff);
    ...
    deleteCurrencyTariff: function deleteCurrencyTariff(activeCurrencyTariff) {
      ...
      this.$store.dispatch("deleteBankCurrencyTariffs", activeCurrencyTariff.id);
    },
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/dashboard/BankCurrency.vue?vue&type=template&id=614825e7&":
/*!***********************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/dashboard/BankCurrency.vue?vue&type=template&id=614825e7& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "col-md-10 pr-md-1"
  }, [_vm._v("\n              " + _vm._s(_vm.getBankCurencyDetails.code) + "\n            ")])]), _vm._v(" "), _c("v-col", {
  ...
  }, [_vm._v("mdi-currency-eur")]), _vm._v("\n                      Buy:\n                      " + _vm._s(_vm.getBankCurencyDetails.buy) + "\n                      "), _c("a", {
    on: {
      click: function click($event) {
        return _vm.OpenEditModule("buy", "Buy Price", _vm.getBankCurencyDetails.buy || 0.0);
      }
    }
  }, [_c("v-icon", {
    attrs: {
  ...
  }, [_vm._v("mdi-currency-eur")]), _vm._v("\n                      Sell:\n                      " + _vm._s(_vm.getBankCurencyDetails.sell) + "\n                      "), _c("a", {
    on: {
      click: function click($event) {
        return _vm.OpenEditModule("sell", "Sell Price", _vm.getBankCurencyDetails.sell || 0.0);
      }
    }
  }, [_c("v-icon", {
    attrs: {
  ...
  }, [_vm._v("mdi-currency-eur")]), _vm._v("\n                      Charge Percentage:\n                      " + _vm._s(_vm.getBankCurencyDetails.chargePercentage) + "\n                      "), _c("a", {
    on: {
      click: function click($event) {
        return _vm.OpenEditModule("chargePercentage", "Charge Percentage", _vm.getBankCurencyDetails.chargePercentage || 0.0);
      }
    }
  }, [_c("v-icon", {
    attrs: {
  ...
  }, [_vm._v("mdi-currency-eur")]), _vm._v("\n                      Txn Fee:\n                      " + _vm._s(_vm.getBankCurencyDetails.transactionFee) + "\n                      "), _c("a", {
    on: {
      click: function click($event) {
        return _vm.OpenEditModule("transactionFee", "Transaction Fee", _vm.getBankCurencyDetails.transactionFee || 0.0);
      }
    }
  }, [_c("v-icon", {
    attrs: {
  ...
  }, [_vm._v("mdi-currency-eur")]), _vm._v("Exchange Rate:\n                      " + _vm._s(_vm.getBankCurencyDetails.exchangeRate) + "\n                      "), _c("a", {
    on: {
      click: function click($event) {
        return _vm.OpenEditModule("exchangeRate", "Exchange Rate", _vm.getBankCurencyDetails.exchangeRate || 0.0);
      }
    }
  }, [_c("v-icon", {
    attrs: {
  ...
  }, [_vm._v("mdi-currency-eur")]), _vm._v("\n                      Currency:\n                      " + _vm._s(_vm.getBankCurencyDetails.currency) + "\n                    ")], 1), _vm._v(" "), _c("p", {
    staticClass: "font-weight-bold"
  }, [_c("v-icon", {
    attrs: {
      color: "primary"
    }
  }, [_vm._v("mdi-currency-eur")]), _vm._v("\n                      Max Withdrow Limite:\n                      " + _vm._s(_vm.getBankCurencyDetails.maxWithdrowLimit) + "\n                      "), _c("a", {
    on: {
      click: function click($event) {
        return _vm.OpenEditModule("maxWithdrowLimit", "Max Withdrow Limit", _vm.getBankCurencyDetails.maxWithdrowLimit || 0.0);
      }
    }
  }, [_c("v-icon", {
    attrs: {
  ...
  }, [_vm._v("mdi-currency-eur")]), _vm._v("\n                      Min Withdrow Limite:\n                      " + _vm._s(_vm.getBankCurencyDetails.minWithdrowLimit) + "\n                      "), _c("a", {
    on: {
      click: function click($event) {
        return _vm.OpenEditModule("minWithdrowLimit", "Min Withdrow Limit", _vm.getBankCurencyDetails.minWithdrowLimit || 0.0);
      }
    }
  }, [_c("v-icon", {
    attrs: {
  ...
  }, [_vm._v("mdi-currency-eur")]), _vm._v("\n                      Max Deposit Limite:\n                      " + _vm._s(_vm.getBankCurencyDetails.maxDepositLimit) + "\n                      "), _c("a", {
    on: {
      click: function click($event) {
        return _vm.OpenEditModule("maxDepositLimit", "Max Deposit Limit", _vm.getBankCurencyDetails.maxDepositLimit || 0.0);
      }
    }
  }, [_c("v-icon", {
    attrs: {
  ...
  }, [_vm._v("mdi-currency-eur")]), _vm._v("\n                      Min Deposit Limite:\n                      " + _vm._s(_vm.getBankCurencyDetails.minDepositLimit) + "\n                      "), _c("a", {
    on: {
      click: function click($event) {
        return _vm.OpenEditModule("minDepositLimit", "Min Deposit Limit", _vm.getBankCurencyDetails.minDepositLimit || 0.0);
      }
    }
  }, [_c("v-icon", {
    attrs: {
  ...
  }, [_vm._v("\n            " + _vm._s("".concat(_vm.activeCurrencyTariff.minAmmount, " - ").concat(_vm.activeCurrencyTariff.maxAmmount, " (").concat(_vm.getBankCurencyDetails.currency, ")")) + "\n          ")]), _vm._v(" "), _c("v-card-text", {
    staticClass: "pa-5"
    ...
    attrs: {
      headers: _vm.headers,
      items: _vm.getBankCurrencyTariffs,
      "item-key": "id"
    },
    scopedSlots: _vm._u([{
      key: "item",
...
/***/ "./resources/js/views/dashboard/BankCurrency.vue":
/*!*******************************************************!*\
  !*** ./resources/js/views/dashboard/BankCurrency.vue ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _BankCurrency_vue_vue_type_template_id_614825e7___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./BankCurrency.vue?vue&type=template&id=614825e7& */ "./resources/js/views/dashboard/BankCurrency.vue?vue&type=template&id=614825e7&");
/* harmony import */ var _BankCurrency_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./BankCurrency.vue?vue&type=script&lang=js& */ "./resources/js/views/dashboard/BankCurrency.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _BankCurrency_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _BankCurrency_vue_vue_type_template_id_614825e7___WEBPACK_IMPORTED_MODULE_0__.render,
  _BankCurrency_vue_vue_type_template_id_614825e7___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/dashboard/BankCurrency.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/views/dashboard/BankCurrency.vue?vue&type=script&lang=js&":
/*!********************************************************************************!*\
  !*** ./resources/js/views/dashboard/BankCurrency.vue?vue&type=script&lang=js& ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_BankCurrency_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./BankCurrency.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/dashboard/BankCurrency.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_BankCurrency_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/views/dashboard/BankCurrency.vue?vue&type=template&id=614825e7&":
/*!**************************************************************************************!*\
  !*** ./resources/js/views/dashboard/BankCurrency.vue?vue&type=template&id=614825e7& ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_BankCurrency_vue_vue_type_template_id_614825e7___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_BankCurrency_vue_vue_type_template_id_614825e7___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_BankCurrency_vue_vue_type_template_id_614825e7___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./BankCurrency.vue?vue&type=template&id=614825e7& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/dashboard/BankCurrency.vue?vue&type=template&id=614825e7&");
