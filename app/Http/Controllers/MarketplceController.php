...
class MarketplceController extends Controller
{
    ...
    {
        $data = Category::where('is_featured', 1)->orderBy('id', 'desc')->orderByRaw('id DESC LIMIT 6')->get();
    ...
    public function loadCategorySubCategories($categoryId)
    {
        $data = Category::where('parent_id', $categoryId)->orderBy('id', 'desc')->get();
    ...
    public function loadBrandProducts($brandId)
    {
        $products = Product::where('products.brand_id', $brandId)
    ...
    {
        $products = Product::where('products.name', 'like', '%' . $queryText . '%')
            ->join('sellers', 'products.seller_id', '=', 'sellers.id')
            ->join('users', 'sellers.user_id', '=', 'users.id')
            ->join('currencies', 'users.country', '=', 'currencies.country_code')
            ->orderBy('products.name', 'desc')->limit(10)
            ->get(['products.*', 'users.user_name', 'currencies.code AS currency']);
