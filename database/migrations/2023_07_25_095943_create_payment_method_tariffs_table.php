...
class CreatePaymentMethodTariffsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('payment_method_tariffs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('payment_method_tariffs');
    }
}
